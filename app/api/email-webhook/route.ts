// app/api/email-webhook/route.ts - Handle incoming email replies via SendGrid
...
export async function GET() {
  return NextResponse.json({
    ...
    info: "This endpoint receives incoming email replies via SendGrid Inbound Parse",
  });
}
