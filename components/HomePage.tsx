...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen text-primary font-mono flex items-center justify-center p-4">
      <motion.div
      ...
      >
        ...
        >
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Card
              className="bg-zinc-900 border-primary/30 hover:border-primary/60 transition-all duration-300 cursor-pointer h-40"
